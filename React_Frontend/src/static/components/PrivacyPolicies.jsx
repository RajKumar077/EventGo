...
class PrivacyPolicies extends Component {
  render() {
    return (
      <div
        className="container"
        style={{ backgroundColor: "#f2f2f2", marginTop: "2em" }}
      >
        <h1 align="center">Privacy Policies</h1>
        <div className="row">
          ...
          >
            ...
            <p>
              ...
              the use of RideShare's Website.
            </p>{" "}
            <br />
            ...
            <br />
            <address>
              Halifax <br />- NS , Canada
              <br />
            </address>
            <p>
              By accessing this website we assume you accept these terms and
              conditions in full. Do not continue to use RideShare's website if
            ...
            <h2>Cookies</h2>
            <p>
              We employ the use of cookies. By using RideShare's website you
              consent to the use of cookies in accordance with RideShare's
              privacy policy.
            </p>
            <p>
            ...
            <h2>License</h2>
            <p>
              Unless otherwise stated, RideShare and/or it's licensors own the
              intellectual property rights for all material on RideShare. All
              intellectual property rights are reserved. You may view and/or
              print pages from http://www.rideshare.ca for your own personal use
              subject to restrictions set in these terms and conditions.
            </p>
            <p>You must not:</p>
            <ol>
              <li>Republish material from http://www.rideshare.ca</li>
              <li>
                Sell, rent or sub-license material from http://www.rideshare.ca
              </li>
              <li>
                Reproduce, duplicate or copy material from
                http://www.rideshare.ca
              </li>
            </ol>
            <p>
              Redistribute content from RideShare (unless content is
            ...
            <p>
              ...
              associated with the hyperlink outweighs the absence of RideShare;
            ...
            <p>
              ...
              <a
                href="mailto:contact@rideshare.ca"
                title="send an email to contact@rideshare.ca"
              >
                contact@rideshare.ca
              </a>
            ...
            <p>
              No use of RideShare's logo or other artwork will be allowed for
